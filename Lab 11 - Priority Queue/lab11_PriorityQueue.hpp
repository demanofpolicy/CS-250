...
public:
    ...
    void Push( T newData, int priority )
    {
        ...
        for(int i = 0; i < m_itemCount; i++)
        {
            ...
            {
                insertAt = i; // not the priority!
                ShiftRight(i);
                break; // break once you find an index to insert at
            }

        }
        cout << "Insert at index " << insertAt << ", item count: " << m_itemCount << ", max size: " << MAX_SIZE << endl;
    ...
    {
        cout << "Shift Right at " << index << ", size is " << m_itemCount << endl;
